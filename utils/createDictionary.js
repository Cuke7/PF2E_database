//
// Don't forget to remove the first lines of dictionnaire-fr.md so that the file starts with "## Actions"
//
const fs = require("fs");
let fullDictionary = [];
fs.readFile("./utils/dictionnaire-fr.md", "utf8", function (err, data) {
  if (err) throw err;
